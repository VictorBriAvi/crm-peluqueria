...
export default function Navbar() {
  ...
  return (
    <header className="backdrop-blur-md bg-white/70 border-b border-gray-200 fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* LOGO */}
          <Link href="/" className="text-2xl font-bold text-blue-600">
            Admin<span className="text-gray-800">Time</span>
          </Link>
